...
export default defineConfig({
  title: "Moonriver",
  description: "A terminal-based console for connecting to Klipper via Moonraker WebSocket API",
  base: '/moonriver/',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'API', link: '/api/' },
      { text: 'GitHub', link: 'https://github.com/yourusername/moonriver' }
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/yourusername/moonriver' }
    ],
